...
- *Begin Assessment (Gate):* Manny begins each run with a coin-flip, turning to face the gate using feedback from our DVL's magnetometer. The vehicle proceeds to submerge and pass under the gate completing two 360#sym.degree roll rotations.
